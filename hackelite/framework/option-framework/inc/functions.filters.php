 ...
 * @return array
 */
function inwave_filter_save_media_upload($data) {
...
add_filter('of_options_before_save', 'inwave_filter_save_media_upload');
 ...
 * @return array
 */
function inwave_of_filter_load_media_upload($data) {
...
add_filter('of_options_after_load', 'inwave_of_filter_load_media_upload');
